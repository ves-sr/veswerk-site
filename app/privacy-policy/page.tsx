	...
	return (
		<section className="py-24">
			<div className="mx-auto max-w-3xl px-6">
				...
				<div className="mt-10 flex flex-col gap-8 text-brown">
					<p>
					...
					<div>
						<h2 className="text-lg font-semibold text-ink">運営者情報</h2>
						<p className="mt-2">
					...
					<div>
						<h2 className="text-lg font-semibold text-ink">取得する情報</h2>
						<p className="mt-2">
							お問い合わせフォームより、以下の情報をご入力いただく場合があります。
						</p>
					...
					<div>
						<h2 className="text-lg font-semibold text-ink">利用目的</h2>
						<p className="mt-2">
					...
					<div>
						<h2 className="text-lg font-semibold text-ink">第三者への提供</h2>
						<p className="mt-2">
							取得した個人情報は、お客様の同意がある場合、または法令に基づく場合を除き、
							第三者に提供することはありません。
						</p>
					</div>

					<div>
						<h2 className="text-lg font-semibold text-ink">外部サービスの利用</h2>
						<p className="mt-2">
					...
					<div>
						<h2 className="text-lg font-semibold text-ink">アクセス解析について</h2>
						<p className="mt-2">
					...
					<div>
						<h2 className="text-lg font-semibold text-ink">開示・訂正・削除について</h2>
						<p className="mt-2">
					...
					<div>
						<h2 className="text-lg font-semibold text-ink">お問い合わせ窓口</h2>
						<p className="mt-2">
					...
					<div>
						<h2 className="text-lg font-semibold text-ink">本ポリシーの改定について</h2>
						<p className="mt-2">
					...
					<p className="text-sm text-brown-light">制定日：2026年8月25日</p>
				</div>
			</div>
		</section>
	);
