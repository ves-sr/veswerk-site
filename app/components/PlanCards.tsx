		...
		<div className="mt-14">
			<Reveal>
				<div className="flex flex-col items-center rounded-[2rem] border border-border bg-bg-sub p-8 text-center sm:mx-16 sm:rounded-[2.5rem] sm:p-14">
					...
					<p
						className="mt-8 w-full min-w-0 max-w-2xl text-sm leading-relaxed text-text-soft"
						style={{ wordBreak: "keep-all", overflowWrap: "break-word" }}
					>
						制作費はホームページを制作・公開するための費用です。保守・管理費は公開後も継続してサポートするための費用で、公開後は月27,500円（税込）が継続して発生します。
					</p>
