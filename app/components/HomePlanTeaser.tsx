...
export default function HomePlanTeaser() {
	return (
		<div className="mt-14 flex flex-col items-start gap-10 sm:flex-row sm:items-end sm:justify-between">
			<div>
				...
				<p className="mt-3 max-w-sm text-sm leading-relaxed text-brown">{plan.priceNote}</p>
			</div>
