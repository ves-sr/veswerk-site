			...
			<section className="border-t border-border bg-bg-sub py-24 sm:py-28 lg:py-32">
				<div className="mx-auto max-w-6xl px-6">
					<ImageTextRow
						...
						heading="なぜ、Web制作の会社が​技術の幅を広げるのか。"
						body={[
							"VESWERKは、ホームページ制作を通じてWebの技術を提供していますが、それを最終的なゴールとは考えていません。",
							"普段は東証プライム上場企業グループで自社開発に携わる、現役のソ⁠フ⁠ト⁠ウ⁠ェ⁠アエンジニアとして、要件定義・設計・開発・運用まで一連の工⁠程に日々携わっています。この技術基盤を土台に、AIやデ⁠ー⁠タ活用な⁠ど、​これまで培っ⁠てきた領域の延長線上に⁠あ⁠る技⁠術⁠へ、​少しずつ挑戦の幅を広げてい⁠き⁠ま⁠す。",
						]}
