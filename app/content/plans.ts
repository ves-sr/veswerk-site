...
export const plans: Plan[] = [
	{
		...
		features: [
			...
			{ text: "Googleマップの情報とサイトの内容を一致させる" },
		],
	},
	{
		key: "standard",
		...
		features: [
			...
			{ text: "電話番号をタップしたらそのまま発信できる仕組み" },
			{ text: "Googleマップの情報とサイトの内容を一致させる" },
			{ text: "お話を伺った人が、そのままデザイン・制作・公開後の保守まで担当", highlighted: true },
	...
	},
	{
		...
		features: [
			{ text: "オーダーメイドデザイン" },
			{ text: "〜8ページ程度", highlighted: true },
			{ text: "スマホの地図をタップしたら迷わずお店まで案内される仕組み" },
			{ text: "電話番号をタップしたらそのまま発信できる仕組み" },
			{ text: "Googleマップの情報とサイトの内容を一致させる" },
			{ text: "お話を伺った人が、そのままデザイン・制作・公開後の保守まで担当" },
			{ text: "写真撮影込み", highlighted: true },
			{ text: "ご自身でブログ・お知らせを更新できる仕組み込み", highlighted: true },
			{ text: "検索で見つかりやすくするための詳細対応（サイトの詳しい情報整理まで）", highlighted: true },
